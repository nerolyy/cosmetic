    ...
    <div class="profile-content">
                    ...
                    <div class="products-grid">
                        <?php foreach ($favorites as $product): ?>
                            <div class="product-card" data-product-id="<?php echo $product['id']; ?>">
                                ...
                                <a href="<?php echo BASE_URL; ?>catalog.php?product=<?php echo htmlspecialchars($product['slug']); ?>" class="product-link">
                                    ...
                                    <?php foreach ($order_items as $item): ?>
                                        <div class="order-item">
                                            <div class="order-item-image">
                                                <?php if ($item['image']): ?>
                                                    <img src="<?php echo BASE_URL . 'uploads/' . htmlspecialchars($item['image']); ?>" alt="<?php echo htmlspecialchars($item['product_name']); ?>">
                                                <?php else: ?>
                                                    <div class="product-image-placeholder">Нет фото</div>
                                                <?php endif; ?>
                                            </div>
        ...
        <?php elseif ($section === 'addresses'): ?>
            ...
            <div class="addresses-section">
                <div class="add-address-form">
                    ...
                    <form id="address-form" method="POST" action="save_address.php">
        ...
        <?php elseif ($section === 'edit'): ?>
            ...
            <div class="edit-profile-section">
                <form method="POST" action="update_profile.php" class="profile-edit-form">
                    <div class="form-group">
