document.addEventListener('DOMContentLoaded', function () {
    // Избранные товары (для карточек товаров)
    ...
    // Избранные товары (для страницы товара - .product-favorite-btn)
    const productFavoriteBtnLarge = document.querySelectorAll('.product-favorite-btn');
    productFavoriteBtnLarge.forEach(button => {
        button.addEventListener('click', function (e) {
            e.preventDefault();
            e.stopPropagation();
